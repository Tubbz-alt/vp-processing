...
```{r single_read}
vp.single <- bioRad::readvp("../data/se-sample/2016/10/03/20/00/searl_vp_20161003T2000Z.h5")
```
...
vp.some <- bioRad::readvp.list(c(
  "../data/se-sample/2016/10/03/20/00/searl_vp_20161003T2000Z.h5",
  "../data/se-sample/2016/10/03/20/15/searl_vp_20161003T2015Z.h5",
  "../data/se-sample/2016/10/03/20/30/searl_vp_20161003T2030Z.h5",
  "../data/se-sample/2016/10/03/20/45/searl_vp_20161003T2045Z.h5"
))
