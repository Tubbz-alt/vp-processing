...
A single vp file contains a data frame with heights as rows and variables as columns (see [the bird profile format specifation](https://github.com/adokter/vol2bird/wiki/ODIM-bird-profile-format-specification) for more information regarding the variables):
