...
```{r setup_load_libraries, results="hide", warning=FALSE, message=FALSE}
...
```{r setup_load_settings, results="hide", warning=FALSE, message=FALSE}
...
3. [Extract vp data](extract-vp.html) (`extract_vp.Rmd`)
4. [Process vp data for the Bird migration flow visualization](vp-to-flowviz.html) (`vp_to_flowviz.Rmd`)
5. [Process vp data for TIMAMP](vp-to-timamp.html) (`vp_to_timamp.Rmd`)
